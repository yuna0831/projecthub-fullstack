                            ...
                            {(!profile.badges?.length && Object.keys(badges).length === 0) ? (
                                ...
                                <div className="grid grid-cols-3 gap-2 relative z-10">
                                    ...
                                    {['CODE_WIZARD', 'DEADLINE_FAIRY', 'COMMUNICATION_KING'].map(type => badges[type] > 0 && (
                                        <div key={type} className="bg-yellow-500/20 p-2 rounded-lg text-center backdrop-blur-sm border border-yellow-500/30 hover:bg-yellow-500/30 transition cursor-help relative" title={type}>
